...
class Semantic_Segmentation_Workflow(Base_Workflow):
    ...
    cfg : YACS configuration
        Running configuration.after_merge
    ...
    def define_metrics(self):
        ...
        if self.cfg.LOSS.TYPE == "CE":
            ...
            self.loss = SoftclDiceDiceBCELoss(alpha_cldice=0.6, alpha_dice=0.4, iter_=10, smooth=0.0000001)
        #elif self.cfg.LOSS.TYPE == "CLDICE": 
